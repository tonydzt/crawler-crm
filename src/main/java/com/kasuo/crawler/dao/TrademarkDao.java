...
//                " WHERE org.has_contact = 1 AND org.employee_id = ?";
                " WHERE org.has_contact = 1 AND org.employee_id = ? and (trademark.address like '%山东%' or trademark.address like '%河北%')";
...
//                " WHERE org.has_contact = 1 AND org.employee_id IS NULL ORDER BY applicant LIMIT ?";
                " WHERE org.has_contact = 1 AND org.employee_id IS NULL and (trademark.address like '%山东%' or trademark.address like '%河北%') LIMIT ?";
